...
from backend.modelos import Producto, Usuario
...
def crear_producto(
    ...
    db: Session = Depends(obtener_db),
    usuario_actual: Usuario = Depends(verificar_rol_admin)  # Solo Administrador
):
...
def actualizar_producto(
    ...
    # Comprobar unicidad si el nombre cambia
    if producto.nombre != producto_in.nombre:
